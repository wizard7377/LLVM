        ...
        FunctionDefC $ MkFunctionDef {
            ...
            body = [MkBlock "entry" [
                ...
                Operation Trash (MiscOp (FnCallOp (MkFnCall NoTail [] (Just C) [] Nothing 
                    ...
                    [
                        MkWithType LPtr ( (LPtr (Local "output"))),
                        MkWithType LPtr ( (LPtr (Local "input"))),
                        MkWithType (LInt 32) ( (LPtr (Local "size")))
                    ] []))),
                Operation Trash (TerminatorOp (Ret LPtr ( (LPtr (Local "output")))))
            ] RetVoid],
            tags = []
        }
    ],
    ...
    text = [
        ...
        FunctionDefC $ MkFunctionDef {
            ...
            body = [MkBlock "entry" [
                ...
                Operation (Local "div_result") (BinaryOp SDiv (LInt 32) ( (LInt 100)) (LVar (Local "input"))),
                -- Check for overflow (proper comparison)
                Operation (Local "overflow_check") (icmp CNe (LInt 32) (LVar (Local "input")) ( (LInt 0))),
                Operation Trash (TerminatorOp (CondBr (LVar (Local "overflow_check")) ( (LPtr (Local "error"))) ( (LPtr (Local "normal")))))
                ] (CondBr (LVar (Local "overflow_check")) ( (LPtr (Local "error"))) ( (LPtr (Local "normal")))),
                    
                MkBlock "error" [
                    -- Unreachable after error
                    Operation Trash (TerminatorOp (Ret (LInt 32) ( (LInt (-1))))),
                ...
                MkBlock "normal" [
                    ...
                    Operation (Local "phi_result") (MiscOp (Phi (LInt 32) [
                        ( (LPtr (Local "div_result")),  (LPtr (Local "entry")))
                    ])),
                    Operation Trash (TerminatorOp (Ret (LInt 32) ( (LPtr (Local "phi_result")))))
                ] (Ret (LInt 32) ( (LPtr (Local "phi_result"))))
            ],
            tags = []
        }
    ],
    ...
    text = [
        ...
        FunctionDefC $ MkFunctionDef {
            ...
            body = [MkBlock "entry" [
                ...
                Operation (Local "is_null") (icmp CEq LPtr (LVar (Local "ptr")) ( LNull)),
                Operation Trash (TerminatorOp (CondBr (LVar (Local "is_null")) ( (LPtr (Local "alloc_failed"))) ( (LPtr (Local "alloc_success")))))
                ] (CondBr (LVar (Local "is_null")) ( (LPtr (Local "alloc_failed"))) ( (LPtr (Local "alloc_success"))))),
                
                MkBlock "alloc_failed" [
                    Operation Trash (TerminatorOp (Ret LPtr ( LNull)))
                ] (Ret LPtr ( LNull)),
        ...
        FunctionDefC $ MkFunctionDef {
            ...
            body = [MkBlock "entry" [
                    ...
                    Operation (Local "fma_result") (MiscOp (FnCallOp (MkFnCall NoTail [] (Just C) [] Nothing 
                        ...
                        [
                            MkWithType (LFloating LDouble) ( (LPtr (Local "sqrt_x"))),
                            MkWithType (LFloating LDouble) ( (LPtr (Local "sin_y"))),
                    ...
                    Operation (Local "is_nan") (MiscOp (FnCallOp (MkFnCall NoTail [] (Just C) [] Nothing 
                        ...
                        [MkWithType (LFloating LDouble) ( (LPtr (Local "fma_result")))] []))),
                    -- Select result based on NaN check
                    Operation (Local "final_result") (MiscOp (Select [] 
                        (MkWithType (LInt 1) ( (LPtr (Local "is_nan"))))
                        (MkWithType (LFloating LDouble) ( (LFloat "0.0"))) 
                        (MkWithType (LFloating LDouble) ( (LPtr (Local "fma_result")))))),
                    Operation Trash (TerminatorOp (Ret (LFloating LDouble) ( (LPtr (Local "final_result")))))
                ] (Ret (LFloating LDouble) ( (LPtr (Local "final_result"))))
            ],
            tags = []
        }
    ],
        ...
        FunctionDefC $ MkFunctionDef {
            ...
            body = [MkBlock "entry" [
                ...
                Operation Trash (MiscOp (FnCallOp (MkFnCall NoTail [] (Just C) [] Nothing 
                    ...
                    [
                        MkWithType LPtr ( (LPtr (Local "root"))),
                ...
                Operation Trash (TerminatorOp (Ret LPtr ( (LPtr (Local "value")))))
                ] 
                (Ret LPtr ( (LPtr (Local "value"))))],
            tags = []
        }
    ],
    tags = Nothing
...
moduleStressTest = MkLModule {
    ...
    text = [
        ...
        FunctionDefC $ MkFunctionDef {
            ...
            metadata = [],
            body = [MkBlock "entry" [
                Operation (Local "result") (BinaryOp Add (LInt 32) (LVar (Local "x")) ( (LInt 1)))
        ...
        FunctionDefC $ MkFunctionDef {
            ...
            metadata = [],
            body = [MkBlock "entry" [
                Operation (Local "result") (BinaryOp Mul (LInt 32) ( (LPtr (Local "x"))) ( (LInt 2))),
                Operation Trash (TerminatorOp (Ret (LInt 32) ( (LPtr (Local "result")))))
            ] (Ret (LInt 32) ( (LPtr (Local "result"))))],
            tags = []
        },
        ...
        FunctionDefC $ MkFunctionDef {
            ...
            metadata = [],
            body = [MkBlock "entry" [
                Operation (Local "cmp1") (icmp CSGt (LInt 32) (LVar (Local "depth")) ( (LInt 0)))
            ] (CondBr (LVar (Local "cmp1")) (LVar (Local "level1")) (LVar (Local "base"))),
                
            MkBlock "level1" [
                Operation (Local "cmp2") (icmp CSGt (LInt 32) (LVar (Local "depth")) ( (LInt 1)))
            ] (CondBr (LVar (Local "cmp2")) (LVar (Local "level2")) (LVar (Local "base"))),
                
            MkBlock "level2" [
                Operation (Local "cmp3") (icmp CSGt (LInt 32) (LVar (Local "depth")) ( (LInt 2)))
            ] (CondBr (LVar (Local "cmp3")) (LVar (Local "level3")) (LVar (Local "base"))),
                
            MkBlock "level3" [
                Operation (Local "sub") (BinaryOp Sub (LInt 32) (LVar (Local "depth")) ( (LInt 1))),
            ...
            MkBlock "base" [
                Operation (Local "phi") (MiscOp (Phi (LInt 32) [
                    ( (LInt 0), LVar (Local "entry")),
                    ( (LInt 1), LVar (Local "level1")),
                    ( (LInt 2), LVar (Local "level2")),
