...
array.so : $(SUPPORT_DIR)/array.c $(SUPPORT_DIR)/array.h 
	@$(CC) -c -fPIC $(SUPPORT_DIR)/array.c -o $(SUPPORT_DIR)/array.o 
	@$(CC) -o $@ -shared $(SUPPORT_DIR)/array.o 
...
clean: clean-test
	...
	@rm -f $(SUPPORT_DIR)/array.so 
	@rm -f $(SUPPORT_DIR)/array.o
	@rm -f array.so
...
docs: install
	...
	@cp -r build/docs/. docs/generated
