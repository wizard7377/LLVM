module System.FFI.LLVM.Prim

import System.FFI.LLVM.Macros
...
LLVMMetadata = CPtr
public export 
LLVMNamedMDNode : Type 
LLVMNamedMDNode = CPtr
public export 
LLVMBuilder : Type 
LLVMBuilder = CPtr
public export 
...
LLVMDIBuilder = CPtr
public export 
LLVMModuleProvider : Type 
LLVMModuleProvider = CPtr
public export 
...
LLVMUse = CPtr
public export 
LLVMOperandBundle : Type 
LLVMOperandBundle = CPtr
public export 
LLVMAttribute : Type 
LLVMAttribute = CPtr
public export 
...
LLVMComdat = CPtr
public export 
LLVMJITEventListener : Type 
LLVMJITEventListener = CPtr
public export 
LLVMBinary : Type 
LLVMBinary = CPtr
public export 
...
public export 
Cast Int Bool where 
  cast x = if x > 0 then True else False 
public export 
Cast Bool Int where 
  cast True = 1
  cast False = 0
...
namespace CPrim 
  ...
  -- Modules
  %runElab decl `[
    LLVMModuleCreateWithName : String -> PM LLVMModule
    LLVMModuleCreateWithNameInContext : String -> LLVMContext -> PM LLVMModule
    LLVMCloneModule : LLVMModule -> PM LLVMModule
    LLVMDisposeModule : LLVMModule -> PM ()
    LLVMSetModuleIdentifier : LLVMModule -> String -> PM ()
    LLVMGetModuleIdentifier : LLVMModule -> PM String
    LLVMAddFunction : LLVMModule -> String -> LLVMType -> PM LLVMValue
  ...
  -- Types
  %runElab decl `[
    LLVMPrintTypeToString : LLVMType -> PM String
    ...
    LLVMStructCreateNamed : LLVMContext -> String -> PM LLVMType
    LLVMStructTypeInContext : LLVMContext -> CList LLVMType -> CUnsigned -> Int -> PM LLVMType
  ...
  %runElab decl `[
    ...
    LLVMConstArray2 : LLVMType -> CList LLVMValue -> CUnsigned -> PM LLVMValue
    LLVMConstNamedStruct : LLVMType -> CList LLVMValue -> CUnsigned -> PM LLVMValue
    LLVMConstString : String -> CUnsigned -> Int -> PM LLVMValue
    LLVMConstStringInContext2 : LLVMContext -> String -> CUnsigned -> Int -> PM LLVMValue
  ...
  -- (Add NoWrap) a case to a switch instruction
  %runElab decl `[
